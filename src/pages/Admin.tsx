...
import { Plus, Trash2, Image as ImageIcon, FileText, LogOut, Save } from "lucide-react";
                    ...
                    <TabsContent value="foto" className="space-y-6">
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <Button onClick={handleAddPhoto} className="w-full gradient-gold">
                    ...
                    <TabsContent value="stampa" className="space-y-6">
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <Button onClick={handleAddDoc} className="w-full gradient-gold">
